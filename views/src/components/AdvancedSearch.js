    ...
    render () {
        return (
            <div className="container-fluid">
                <h2>{translations[this.props.translationState].advanced_search.header}</h2>
                <form>
                    <div>
                        <label>{translations[this.props.translationState].advanced_search.seen}</label>
                    ...
                    <div>
                        <label>{translations[this.props.translationState].advanced_search.public}</label>
                    ...
                    <div>
                        <label>{translations[this.props.translationState].advanced_search.minimum_rating}</label>
                        <input onChange={this.props.advanceSearchFunction} ref={this.props.rating} type="range" defaultValue="1" name="rating" min="1" max="10"/>
                    </div>
                    <div>
                        <label>{translations[this.props.translationState].advanced_search.maximum_duration}</label>
                    ...
                    <div>
                        <label>{translations[this.props.translationState].advanced_search.decade}</label>
                    ...
                    <button onClick={this.props.clearAdvancedSearch}>{translations[this.props.translationState].advanced_search.clear_search}</button>
                </form>
            </div>
        )
    }
